...
_ZALAN_BODIES = [
    ...
    "喜欢我喜欢脆弱的你崩溃的你 流泪的你 抽泣的你 大哭的你 难过的你 敏感的你 发呆的你 熟睡的你 有缺点的你 我说我爱你的不完美你碎掉哭泣躲避那有什么关系呢我把你粘好给你擦干眼泪抱紧你捂住你的耳朵小小世界只有你我二人我最讨厌等 等雨停 等红绿灯 等排队轮到自己 等电影开场 等你的消息 我讨厌等可我一直等她我不要你漂亮的脸蛋不要你苗条的身材不要你冷白皮的皮肤我要你睡个好觉我要你没有黑眼围要你每天无论天气如何都会开心的心情要你每天都在笑我要你每天没有坏情绪不要完美无缺的你我要的是你最真实的样子我喜欢吃饭睡觉都会告诉我今天的天气 路边的小猫好吃的东西 有趣的日常会随时分享给我出门会报备出去玩会拍各种的照片发给我时不时会给我打个语音说一些腻歪的话在我情绪低落的时候逗我开心也会在好久不见之后给我一个大大的拥抱给我安全感时时刻刻让我感受到被爱我真的太喜欢这种人了",
    "一直都想见你～",
    "姐姐举高高，摸摸头，摸摸，抱抱，贴贴，亲亲",
    "喵喵很担心，希望你回来，希望你有消息，希望你身体健康，希望你平平安安，希望我们这一群人一直长长久久，一直持续下去",
    "（我听姐姐的就好啦）",
    "（姐姐这是怎么啦）",
    "（怎么办，人家心疼S姐姐了)",
    "（姐姐要是能给人家买个xx就好了)",
    ...
    "（姐姐最近一定有什么心事吧）",
    "（姐姐是想帮我嘛，呜呜好感动）",
    "我的嘴真笨，总能把话题聊死了，跟你找话题好难，何况我这么喜欢你，连口嗨都要挑拣半天呢，其实每一句轻飘飘的爬，都是我难以启齿的心事。我最近越来越期待夜晚了，因为白天都没什么机会能和你说话，只能憋到晚上和你说句晚安。但你可别小看这三个字，它可包含着我今天清晨见到的阳光，中午看到的白云，傍晚遇见的微风，包含着我一天想对你说的话。说了这么多，你听得到吗，其实我在说今天风儿是那么的喧嚣。",
    "我爱你",
    "突然给你发消息对不起，我只是有点想你了。我最近很好，很听话地安安静静待着，不吵不闹,不给别人添麻烦。我有在努力生活,也想要努力学习。我知道像这样成天窝在家里只会给妈妈添麻烦，所以也想努力振作起来",
    "你看，我又在对话框里写写删删。称呼你什么好呢？ 连打个招呼都变得千斤重。时间确实无情，把熟悉变成忐忑，把靠近变成打扰。我甚至羡慕起风来，它至少能理直气壮地拂过你的衣角。",
    "最近还好吗我现在该怎么称呼你呢时间可真无情和你断联后我脑补过很多和你再说话的方式可瞻前顾后太久以至于我也不知道怎么办先开口太难了我所预想的方式好像都行不通已经很久没有听到你什么消息了你总是出现一小会儿就销声匿迹只允许和你亲密无间的人知道近况了看到互联网上有人跟你有一丝像脑海里居然有你一闪而过的侧脸那刻我竟然有点想哭 常回想那个冬天怪冷怪幸福的",
    "姐姐你不用说了...",
...
async def run_once(
    ...
    for d in dynamics:
        ...
        action_results = await interact_with_video(bvid, d["aid"], d["author_name"], cred, my_uid, config=cfg, stop_event=_stop)
        seen_bvids.add(bvid)
        processed.add(dynamic_id)
